...
<h1>Calculate Your Ride Fare</h1>
...
<div class="fareCalculatorContainer">
    ...
    <div class="fareDesc">
        ...
        <p>
            Use our convenient fare calculator to estimate the cost of your ride.
            Simply enter your starting point and destination, and we'll provide you with an instant fare estimate based
            on our transparent pricing structure.
        </p>
    </div>

    <div class="fareFormContainer">
        <form action={{ route('fare.calculation') }} method="post">
            @csrf
            <input type="text" name="location" id="location" placeholder="click on use my location button please"
                autocomplete="off" required onkeydown="return false"><br>
