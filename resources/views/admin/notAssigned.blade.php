...
<body>
    ...
    <section class="tableSection">
        ...
        <h1>Not Assigned Trips</h1>

        <form method="GET" action="{{ route('notAssigned') }}">
        ...
        <button class="notAssigned" onclick="window.location.href='{{ route('AdminPage') }}'">All Trips</button>
