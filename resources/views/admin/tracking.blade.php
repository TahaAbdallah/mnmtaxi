...
<head>
    ...
    <script async
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBdWfSJJ2c_entp53CpUFSIYnb960pQS5o&loading=async&callback=initMap">
    </script>
...
function updatePosition(){
    const latlng = { lat: -23.344, lng: 131.031 };
...
<body class="antialiased">
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBdWfSJJ2c_entp53CpUFSIYnb960pQS5o&callback=initMap&v=weekly"
        async></script>
